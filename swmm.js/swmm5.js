...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'swmm5.data';
      var REMOTE_PACKAGE_BASE = 'swmm5.data';
  ...
  Module['FS_createPath']("/", "data", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_swmm5.data');

      };
      Module['addRunDependency']('datafile_swmm5.data');
   ...
   loadPackage({"files": [{"filename": "/data/Example1.inp", "start": 0, "end": 17285, "audio": 0}], "remote_package_size": 17285, "package_uuid": "407d4eb6-aacd-4fe1-9ceb-ca25c10b0559"});
